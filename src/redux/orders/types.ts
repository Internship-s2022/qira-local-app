...
export enum Actions {
  ...
  GET_CLIENT_ORDER_BY_ID_PENDING = 'GET_CLIENT_ORDER_BY_ID_PENDING',
  GET_CLIENT_ORDER_BY_ID_SUCCESS = 'GET_CLIENT_ORDER_BY_ID_SUCCESS',
  GET_CLIENT_ORDER_BY_ID_ERROR = 'GET_CLIENT_ORDER_BY_ID_ERROR',
